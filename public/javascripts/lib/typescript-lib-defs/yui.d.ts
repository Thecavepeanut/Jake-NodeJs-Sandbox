declare module Y {
    ...
    interface Base extends BaseCore, Attribute, AttributeEvents, AttributeExtras, EventTarget {
        (config: any);


        destroy(d? : boolean): Base;
...
//        unsubscribe(fn: Function, context: any): number;
        unsubscribe(fn: Function, context: any): any;
...
//        setHTML(content: string): Node;
        ...
        size(): number;
        simulate(type: string, options?: any): any;
        simulateGesture(name: string, options?: any, cb?: (err: Error) => any): any;
        select(): Node;
        ...
        toString(): string;
        toggleClass(className: string) : Node;
    ...
    interface Test_Reporter {
        ...
        clearFields(): any;
        addField(name: string, value: any): any;
        destroy(): any;
    ...
    interface Widget extends Base {
        ...
        enable(): Widget;
        focus(): Widget;
        render(parentNode? : string) : Widget;
        render(parentNode? : Node) : Widget;
...
//        clone(o: any, safe: boolean, f: Function, c: any, owner: any, cloned: any): any[];
        ...
        mix(receiver: Function, supplier: Function, overwrite?: boolean, whitelist?: String[], mode?: number, merge?: boolean): Function;
        mix(receiver: Function, supplier: any, overwrite?: boolean, whitelist?: String[], mode?: number, merge?: boolean): Function;
        mix(receiver: any, supplier: Function, overwrite?: boolean, whitelist?: String[], mode?: number, merge?: boolean): Function;
        mix(receiver: any, supplier: any, overwrite?: boolean, whitelist?: String[], mode?: number, merge?: boolean): Function;
...
//        mix(receiver: Function, supplier: Function, overwrite?: boolean, whitelist?: String[], mode?: number, merge?: boolean): YUI;
//        mix(receiver: Function, supplier: any, overwrite?: boolean, whitelist?: String[], mode?: number, merge?: boolean): YUI;
//        mix(receiver: any, supplier: Function, overwrite?: boolean, whitelist?: String[], mode?: number, merge?: boolean): YUI;
//        mix(receiver: any, supplier: any, overwrite?: boolean, whitelist?: String[], mode?: number, merge?: boolean): YUI;
...
//        one(node: HTMLElement): any;
    ...
    interface DD_DDMStatic extends EventTarget {
        new (): DD_DDM;
    ...
    interface DD_DragStatic {
        // TODO: these are defined in the YUI docs as not taking arguments, however they can be sent as DD_Drag
        // extends from Base
        new (config? : any): DD_Drag;
    ...
    interface DataTable extends Widget {
        ...
        getRow(row: string): any;
        getRow(row:Y.Model): any;
    ...
    interface Event {
        ...
        simulate(target: HTMLElement, type: string, options: any): any;
        simulateGesture(node: HTMLElement, name: string, options?: any, cb?: (err: Error) => any): any;
        simulateGesture(node: Node, name: string, options?: any, cb?: (err: Error) => any): any;
    }
    ...
    interface JSON {
        ...
        parse(s: string) : any; // YUI docs specify that reviver is optional
    ...
    interface Profiler {
        ...
        pause(name: string): any;
        registerConstructor(name: string, owner: any): any;
        registerFunction(name: string, owner: any, registerPrototype: boolean): any;
        registerObject(name: string, owner: any, recurse: boolean): any;
        start(name: string): any;
        stop(name: string): any;
        unregisterObject(name: string, recurse: boolean): any;
        unregisterFunction(name: string): any;
    }
    ...
    interface Test_ArrayAssert {
        ...
        itemsAreEquivalent(expected: any[], actual: any[], comparator: Function, message: string): any;
    ...
    interface Test_Assert {
        ...
        isany(actual: any, message: string): any;
        isNull(actual: any, message: string): any;
        isNotany(actual: any, message: string): any;
        ...
        pass(): any;
        throwsError(expectedError: string, method: Function, message: string): any;
        throwsError(expectedError: Function, method: Function, message: string): any;
        throwsError(expectedError: any, method: Function, message: string): any;
    }
    ...
    interface Test_EventTarget {
        ...
        attach(type: string, listener: Function): any;
        detach(type: string, listener: Function): any;
        fire(event: any): any;
        fire(event: string): any;
        subscribe(type: string, listener: Function): any;
        unsubscribe(type: string, listener: Function): any;
    }

    interface Test_Mock {


        expect(mock: any, expectation: any): any;
        verify(mock: any): any;
    }
    ...
    interface Test_Results {
        ...
        include(result: Test_Results): any;
    }
    ...
    interface Test_Runner {
        ...
        getName(): string;
        run(options: any): any;
        run(options: boolean): any;
        resume(segment: Function): any;
    ...
    interface Test_TestCase {
        ...
        setUp(): any;
        tearDown(): any;
        wait(segment: Function, delay: number): any;
    }
    ...
    interface Test_TestSuite {
        ...
        add(testObject: Test_TestSuite): any;
        add(testObject: Test_TestCase): any;
        setUp(): any;
        tearDown(): any;
    }

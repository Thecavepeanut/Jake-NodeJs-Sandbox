...
export module Svg {
    ...
    export interface Brush {
         ...
         */
             ...
             */
            (): D3.ScaleModule.Scale;
            /**
             * Sets the x-scale associated with the brush
             *
             * @param accessor The new ScaleModule
             */
            (scale: D3.ScaleModule.Scale): Brush;
        };
        /**
         * Gets or sets the x-scale associated with the brush
         */
...
export module Behavior {
    ...
    export interface Zoom {
         ...
         */
            x: {
            /**
             * Get the X-ScaleModule
             */
            (): D3.ScaleModule.Scale;
            /**
             * Set the X-ScaleModule to be adjusted
             *
             * @param x The X ScaleModule
             */
            (x: D3.ScaleModule.Scale): Zoom;
         ...
         */
            y: {
            /**
             * Get the Y-ScaleModule
             */
            (): D3.ScaleModule.Scale;
            /**
             * Set the Y-ScaleModule to be adjusted
             *
             * @param y The Y ScaleModule
             */
            (y: D3.ScaleModule.Scale): Zoom;
        };
    }
